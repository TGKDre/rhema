...
import { ProPresenterPanel } from "@/components/panels/propresenter-panel"
...
export function Dashboard() {
  return (
    ...
    >
      ...
      {/* Row 3: Search + Detections + ProPresenter */}
      <div className="col-span-4 grid min-h-0 grid-cols-[2fr_1fr_300px] gap-3 px-3 pb-3">
        <SearchPanel />
        <DetectionsPanel />
        <ProPresenterPanel />
      </div>
